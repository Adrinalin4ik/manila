...
//!   corpus's animated texture transforms render for a consumer that runs none of them.
...
pub use material::{
    alphascan, blendscan, envmapscan, fxuvscan, texmodescan, uvslotscan, uvwrapscan,
};
pub use particles::{
